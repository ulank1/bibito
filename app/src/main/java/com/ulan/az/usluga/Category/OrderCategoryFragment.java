 ...
 */
public class OrderCategoryFragment extends Fragment implements FilterListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e("ONCREATEORDER",getArguments().getInt("tag")+" ");
...
*/
    ...
    public void onFilter(int id) {
      /*  Log.e("Siiii",categories.get(0).getCategory()+"");
        adapter = new RVCategoryAdapter(getActivity(), categories, getArguments().getInt("tag"));
        mRecyclerView.setAdapter(adapter);*/
