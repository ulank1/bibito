...
public class ForumSubCategoryActivity extends AppCompatActivity {
...
*/
            ...
            public void onApiResponse(String id, String json, boolean isOk) {
                ...
                if (isOk) {
                    try {
                        ...
                        adapter = new RVForumCategoryAdapter(ForumSubCategoryActivity.this, serviceArrayList, 2);
        ...
        ClientApi.requestGet(URLS.forum_sub_category + "&category=" + category.getId(), listener);
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (categories1.size() == 0) {
                    ...
                    adapter = new RVForumCategoryAdapter(ForumSubCategoryActivity.this, categories1, 2);
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            mRecyclerView.setAdapter(adapter);
