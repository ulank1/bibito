...
import com.ulan.az.usluga.Profile.RVMyOrderAdapter;
...
public class TenderOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivityForResult(new Intent(TenderOrderActivity.this, AddOrderActivity.class),3);
            }
        });
    ...
    void getOrder(){
                ...
                if (isOk) {
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            orders.add(service);
                            adapter = new RVTenderOrderAdapter(TenderOrderActivity.this,orders,getIntent().getIntExtra("service_id",1));
        ...
        ClientApi.requestGet(URLS.order + "&user=" + String.valueOf(E.getAppPreferencesINT(E.APP_PREFERENCES_ID, TenderOrderActivity.this)), listener);
