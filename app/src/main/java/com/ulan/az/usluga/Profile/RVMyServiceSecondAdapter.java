...
public class RVMyServiceSecondAdapter extends RecyclerView.Adapter<RVMyServiceSecondAdapter.PersonViewHolder> {
    Context context;
    User vse;
       ...
       ProgressBar progressBar;
        ...
        PersonViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                   ClientApiListener listener = new ClientApiListener() {
                        ...
                        public void onApiResponse(String id, String json, boolean isOk) {
                            ...
                            if (isOk) {
                                try {
                                    ...
                                    context.startActivity(new Intent(context,OrderMoreInfoActivity.class).putExtra("service",service));
                    ...
                    ClientApi.requestGet(URLS.order+"&user="+listVse.get(getAdapterPosition()).getId(),listener);
            ...
            check.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                 //   RVMyOrderAdapter.delete(position,id,context,rvMyOrderAdapter);
                    ClientApi.requesPutStatus(URLS.confirm_delete_service+listVse.get(getAdapterPosition()).getId_confirm()+"/",0);
            ...
            cancel.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    ClientApi.requesPutStatus(URLS.confirm_delete_service+listVse.get(getAdapterPosition()).getId_confirm()+"/",2);
                    listVse.remove(getAdapterPosition());
                    notifyDataSetChanged();
                }
            });
    ...
    int id;
    int position;
    RVMyServiceAdapter rvMyOrderAdapter;

    public RVMyServiceSecondAdapter(Context context, ArrayList<User> listVse, int id, int position, RVMyServiceAdapter rvMyOrderAdapter) {
