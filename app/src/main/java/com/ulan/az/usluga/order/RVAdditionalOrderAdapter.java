...
public class RVAdditionalOrderAdapter extends RecyclerView.Adapter<RVAdditionalOrderAdapter.PersonViewHolder> {
    Context context;
    Service vse;
    ...
    public RVAdditionalOrderAdapter(Context context, ArrayList<Service> listVse) {
