 ...
 */
public class TenderServiceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar.setVisibility(View.VISIBLE);
            ...
            ClientApi.requestGet(URLS.confirm_service + "&user="+E.getAppPreferencesINT(E.APP_PREFERENCES_ID,getActivity()), listener);
