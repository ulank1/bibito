package com.ulan.az.usluga.tender;
...
import com.ulan.az.usluga.Profile.RVMyOrderSecondAdapter;
...
public class RVTenderOrderAdapter extends RecyclerView.Adapter<RVTenderOrderAdapter.PersonViewHolder> {
    Activity context;
    Service vse;
    ...
    public class PersonViewHolder extends RecyclerView.ViewHolder {
        ...
        PersonViewHolder(final View itemView) {
            ...
            imageView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    delete(getAdapterPosition(), listVse.get(getAdapterPosition()).getId(), context, RVTenderOrderAdapter.this);
                }
            });
            ...
            itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final MultipartBody req = new MultipartBody.Builder().setType(MultipartBody.FORM)
                            ...
                            .addFormDataPart("order", "/api/v1/service/" + String.valueOf(service_id + "/")).build();

                    ClientApi.requestPost(URLS.confirm_delete_service, req, listener1);
    ...
    public RVTenderOrderAdapter(Activity context, ArrayList<Service> listVse, int service_id) {
    ...
    public static void delete(int position, int id, Context context, RVTenderOrderAdapter rvMyOrderAdapter) {
